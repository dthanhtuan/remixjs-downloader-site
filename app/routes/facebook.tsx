...
import {Form, json, useActionData, Link} from "@remix-run/react";
        ...
        <div className="bg-gray-50 min-h-screen">
            <nav className="bg-white shadow-sm py-4">
                <div className="container mx-auto flex justify-between items-center px-6">
                    <h1 className="text-2xl font-semibold text-blue-600">Facebook Download</h1>
            ...
            <section className="text-center py-12">
                <h2 className="text-3xl font-bold">
                    <span className="text-blue-600">Facebook</span> Video Downloader
                </h2>
                <p className="text-gray-600 mt-2">Download Facebook videos from any post.</p>
                <Form method="post" className="mt-6 flex justify-center">
                    <input
                        ...
                        placeholder="Enter a Facebook Post Link e.g. https://facebook.com/..."
            ...
            <section className="bg-white shadow-md rounded-lg p-6 mx-auto w-4/5 mt-8">
                <h3 className="text-xl font-semibold mb-4">How to Download Facebook Videos</h3>
